...
urlpatterns = [
    ...
    path("recuperar-contrasena/nueva/", views.password_reset_page, name="password_reset_page"),
    path("recuperar-contrasena/completar/", views.password_reset_complete, name="password_reset_complete"),
